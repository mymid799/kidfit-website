...
export const BLUEPRINTS: StoryBlueprint[] = [
    ...
    },
    {
        ...
        empathyChoices: [
            { id: 'wait_friend', icon: '⏳', label: 'Dừng lại chờ bạn Rô-bốt bị hỏng xe', label_en: 'Stop and wait for broken-down Robot', consequence: 'Character sacrifices winning to help a friend — teaches sportsmanship over winning' },
            { id: 'share_fuel', icon: '⛽', label: 'Chia sẻ nhiên liệu cho bạn Rô-bốt', label_en: 'Share fuel with Robot friend', consequence: 'Character shares resources — teaches generosity even in competition' },
            { id: 'finish_together', icon: '🤝', label: 'Kéo xe bạn cùng về đích!', label_en: 'Tow friend car to finish together!', consequence: 'Character chooses friendship over glory — teaches that winning together is better' },
        ],
        guardianId: 'clanky_robot',
    ...
    // ══════════════════════════════════════════════════════════════════════════
    {
        ...
        choices: [
            { id: 'give_scarf', icon: '🧣', label: 'Đưa khăn ấm của mình cho bạn', label_en: 'Give your own warm scarf', consequence: 'Character takes off their scarf and wraps it around the rabbit. Character shivers a little but smiles seeing the rabbit warm up. A golden glow surrounds them both.', consequence_en: 'Self-sacrifice: giving up personal comfort — teaches SHARING' },
            { id: 'build_shelter', icon: '🏠', label: 'Xây nhà lá để cùng trú mưa', label_en: 'Build a leaf shelter together', consequence: 'Character gathers giant colorful leaves and builds a creative shelter. Both hide inside giggling. Rain patters on the roof. The rabbit is amazed by the creativity.', consequence_en: 'Problem-solving: using creativity to help — teaches RESOURCEFULNESS' },
            { id: 'call_friends', icon: '📢', label: 'Gọi tất cả bạn đến giúp!', label_en: 'Call all friends to come help!', consequence: 'Character cups hands and calls out loudly. A parade of forest animals rushes in — everyone brings something warm. The rabbit is surrounded by friends.', consequence_en: 'Leadership: organizing a group to help — teaches TEAMWORK' },
        ],
        empathyChoices: [
            { id: 'gift', icon: '🎁', label: 'Tặng bạn một món quà kỷ niệm', label_en: 'Give a keepsake gift', consequence: 'Generosity — giving something precious to show lasting care' },
            { id: 'teach', icon: '📖', label: 'Dạy bạn cách giữ ấm lần sau', label_en: 'Teach friend how to stay warm next time', consequence: 'Knowledge sharing — empowering the friend to help themselves' },
            { id: 'promise', icon: '🤙', label: 'Hứa sẽ luôn ghé thăm bạn', label_en: 'Promise to always visit', consequence: 'Commitment — showing that friendship is a lasting bond' },
        ],
    ...
    },
    {
        ...
        choices: [
            { id: 'sneak_look', icon: '🔍', label: 'Rón rén tới xem là ai', label_en: 'Sneak over to see who it is', consequence: 'Character carefully tip-toes through the bushes, peeking between leaves. Discovers a tiny lost firefly whose light has gone out. The firefly looks scared.', consequence_en: 'Curiosity: carefully investigating before reacting — teaches OBSERVATION' },
            { id: 'brave_step', icon: '🦁', label: 'Dũng cảm bước tới giúp liền!', label_en: 'Bravely walk over to help right away!', consequence: 'Character marches forward confidently and pushes the bushes apart. Finds a baby bird with a hurt wing. Character isn\'t scared at all and the bird feels safe immediately.', consequence_en: 'Bravery: acting without hesitation — teaches COURAGE' },
            { id: 'call_out', icon: '🗣️', label: 'Gọi to: "Bạn ơi, đừng sợ!"', label_en: 'Call out: "Don\'t be scared, friend!"', consequence: 'Character shouts reassuring words into the dark. A shy tiny creature slowly peeks out — it\'s a lost baby mushroom spirit! It was scared of the dark too!', consequence_en: 'Communication: using words to comfort — teaches VERBAL REASSURANCE' },
        ],
        empathyChoices: [
            { id: 'stay_night', icon: '🌙', label: 'Ở lại qua đêm cùng bạn mới', label_en: 'Stay overnight with new friend', consequence: 'Sacrifice personal comfort to ensure a friend feels safe' },
            { id: 'light_way', icon: '🔦', label: 'Thắp sáng đường cho bạn về nhà', label_en: 'Light the way home for friend', consequence: 'Guide others safely — practical help with personal effort' },
            { id: 'introduce', icon: '👋', label: 'Giới thiệu bạn với nhóm của mình', label_en: 'Introduce friend to your group', consequence: 'Social inclusion — making sure no one is left alone' },
        ],
        guardianId: 'professor_owl',
        preferredBiome: 'whispering_forest',
    ...
    },
    {
        ...
        empathyChoices: [
            { id: 'carry_home', icon: '🏡', label: 'Bế bạn sao về nhà an toàn', label_en: 'Carry baby star safely home', consequence: 'Personal responsibility — taking full care of someone fragile' },
            { id: 'find_family', icon: '👨‍👩‍👧', label: 'Giúp bạn sao tìm lại gia đình', label_en: 'Help star find her family', consequence: 'Reuniting families — understanding the importance of belonging' },
            { id: 'make_nest', icon: '🪺', label: 'Xây tổ mới ở nơi thấp hơn', label_en: 'Build a new nest somewhere lower', consequence: 'Creating safe spaces — preventing future problems' },
        ],
        guardianId: 'tiny_rabbit',
