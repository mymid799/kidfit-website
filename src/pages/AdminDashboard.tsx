...
import LessonOversightManager from './AdminDashboard/LessonOversightManager';
...
const AdminDashboard = () => {
    ...
    const navItems = [
        ...
        {
            id: 'lessons', label: 'Quản duyệt Giáo án', badge: 'AI',
        ...
        <div className="flex h-screen overflow-hidden" style={{ fontFamily: "'Quicksand', sans-serif", backgroundColor: '#F8FAFC', color: '#334155' }}>
            ...
            <main className="flex-1 flex flex-col min-w-0 overflow-hidden w-full">
                ...
                <div className="flex-1 overflow-y-auto p-4 md:p-6" style={{ scrollbarWidth: 'thin' }}>
                    ...
                    {activeTab === 'lessons' && <LessonOversightManager />}
                    {activeTab === 'staff' && <StaffManagement />}
                    {activeTab === 'settings' && <SystemSettings />}
                    {!['overview', 'accounts', 'classes', 'lessons', 'attendance', 'nutrition', 'fees', 'staff', 'settings'].includes(activeTab) && (
