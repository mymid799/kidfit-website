...
export default function AIDrawing3DPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#f0fdf4] via-[#f8faff] to-white font-display antialiased">
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between px-6 md:px-12 py-3">
          <Link to="/" className="flex items-center gap-3 group">
            ...
            <div className="hidden sm:flex flex-col leading-tight">
              ...
              <span className="text-[10px] font-bold text-emerald-600 uppercase tracking-widest">Drawing Explorer 3D</span>
            </div>
          </Link>
        ...
        <div className="max-w-7xl mx-auto relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            ...
            <h1 className="text-3xl md:text-4xl font-black leading-tight mb-2">
              Khám Phá Qua Nét Vẽ <span className="text-yellow-300">3D</span>
            </h1>
            <p className="text-white/80 text-sm max-w-lg leading-relaxed">
              Tải lên bức vẽ của bé — AI sẽ <strong className="text-white">nhận diện, chấm điểm</strong> và dựng
              <strong className="text-yellow-200"> mô hình 3D tương tác</strong> ngay lập tức. <strong className="text-yellow-200">Hoàn toàn miễn phí</strong>, không cần tài khoản.
            </p>
          </div>
          ...
          <div className="flex flex-wrap gap-2 md:flex-col md:items-end">
            {[
              { icon: 'psychology', label: 'Gemini Vision AI' },
              { icon: 'view_in_ar', label: 'Mô hình 3D tương tác' },
              { icon: 'rate_review', label: 'Nhận xét chi tiết' },
              { icon: 'palette', label: '50+ mẫu vật 3D sẵn' },
            ].map((f) => (
      ...
      <main className="max-w-7xl mx-auto px-4 md:px-8 py-12">
        ...
        <div className="mb-8 flex items-start gap-3 bg-amber-50 border border-amber-200 rounded-2xl p-4 text-amber-800">
          ...
          <div className="flex flex-col gap-1">
            <span className="text-sm font-bold">Bạn đang dùng bản thử nghiệm</span>
            <span className="text-xs leading-relaxed">
              Tính năng đầy đủ — lưu kết quả, theo dõi tiến bộ, quản lý lớp học — chỉ dành cho tài khoản giáo viên.{' '}
              <Link to="/login" className="font-bold underline hover:text-amber-900">Đăng nhập ngay →</Link>
            </span>
          </div>
        </div>

        {/* The actual Drawing Explorer 3D component — reused 1:1 from teacher dashboard */}
        ...
        <div className="mt-12 bg-gradient-to-br from-[#186A3B] to-emerald-500 rounded-3xl p-8 text-white text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/80 text-sm max-w-md mx-auto mb-6">
              Mở khóa toàn bộ hệ sinh thái: Cỗ Máy Kể Chuyện AI, Giáo án AI, Drawing Explorer 3D và nhiều hơn nữa.
            </p>
      ...
      <footer className="border-t border-slate-100 py-6 text-center text-slate-400 text-xs font-medium">
        © 2026 Trạng Nguyên Kids 4.0 — Drawing Explorer 3D · Phi lợi nhuận · Dành cho giáo dục
      </footer>
    </div>
  );
}
