...
import AILessonPlannerTab from '../../curriculum/components/AILessonPlannerTab';
import { EditProfile } from '../../account/components/EditProfile';
...
import ClassJournalView from '../components/ClassJournalView';
import MediaLibraryView from '../components/MediaLibraryView';
import MessagesView from '../components/MessagesView';
import NotificationsManageView from '../components/NotificationsManageView';
...
export default function TeacherDashboard() {
    ...
    const navItems = [
        ...
        { id: 'lessons-plan', label: 'Soạn bài AI', icon: 'magic_button' },
        { id: 'lessons-repository', label: 'Hồ sơ Giáo án', icon: 'verified_user' },
        ...
        { id: 'ar-scanner', label: 'Quét AR Học cụ', icon: 'view_in_ar', section: 'CÔNG NGHỆ' },
        ...
        <div className="flex h-screen overflow-hidden bg-[#f6f7f6] font-display text-slate-800">
            ...
            <main className="flex-1 flex flex-col min-w-0 overflow-y-auto relative w-full">
                ...
                <div className="px-4 md:px-8 pb-10 space-y-8">
                    ...
                    { activeTab === 'lessons-repository' && <TeacherLessonManager /> }
                    { activeTab === 'storyboard' && <AIStoryboardTab /> }
                    {activeTab === 'profile' && <EditProfile onSaveSuccess={refreshProfile} />}

                    {!['overview', 'document-repository', 'attendance', 'students', 'journal', 'media', 'messages', 'lessons-plan', 'lessons-repository', 'storyboard', 'profile'].includes(activeTab) && (
